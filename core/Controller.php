<?php
    ...
    class Controller {
        ...
        protected function setMessage(int $msgLvl, string $msgTitle, string $msgText, string $msgLink=null, string $msgLinkText=null)
        {// 0 success/ 1 error / 2 info
            $this->set('msgLvl', $msgLvl);
            $this->set('msgTitle', $msgTitle);
            $this->set('msg', $msgText);
            $this->set('msgLink', $msgLink);
            $this->set('msgLinkText', $msgLinkText);
        }
    }
